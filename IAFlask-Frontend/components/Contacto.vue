<template>
  <b-container>
    <div>
      ...
      <h1 class="row justify-content-center">Contacto</h1>
      <b-form @submit="onSubmit" @reset="onReset">
        ...
        <b-form-group id="input-group-3" label="Motivo:" label-for="input-3">
          <b-form-select
            id="input-3"
            v-model="form.opcion"
            :options="opciones"
      ...
      <b-card class="mt-3" header="Formulario a enviar">
